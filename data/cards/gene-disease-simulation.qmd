...
- [Day 1 slides](../../slides/day-01-monday.html) — logistic regression, boundaries
- [Day 2 slides](../../slides/day-02-tuesday.html) — classification trees, step-by-step splits in Gene1 x Gene3 plane
...
**Simulated in R** (`set.seed(123)`). Same story as [logistic-regression-gene-disease.Rmd](../../notebooks/logistic-regression-gene-disease.Rmd) and the [Day 1 data card example (archived)](https://github.com/s-peischl/ML_SS_2026/blob/main/exercises/solutions/_archive/day01-data-card-example.qmd).

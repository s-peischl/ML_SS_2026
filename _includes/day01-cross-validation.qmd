...
![](../assets/figures/LOOCV.gif){width=50% fig-align="center"}
...
- Lab **1D** (optional): manual **5-fold** loop vs `cv.glmnet` — same idea, different $k$. Archived write-up: [manual k-fold CV](https://github.com/s-peischl/ML_SS_2026/blob/main/exercises/solutions/_archive/day01-manual-kfold-cv.Rmd).
